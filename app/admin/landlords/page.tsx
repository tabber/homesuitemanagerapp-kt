...
const mockLandlords = [
  {
    ...
    monthlyAmount: 94.99,
    activityLog: [
      { date: "May 28, 2026", action: "Recorded payment for Unit 4B" },
      { date: "May 25, 2026", action: "Added new property: Oak Street Duplex" },
      { date: "May 20, 2026", action: "Created lease for Riverside Apartments" },
      { date: "May 15, 2026", action: "Account created" },
    ],
    supportNotes: "",
  },
  {
    ...
    billingDate: "June 12, 2026",
    monthlyAmount: 124.99,
    activityLog: [
      { date: "May 27, 2026", action: "Sent message to tenant" },
      { date: "May 22, 2026", action: "Updated property details" },
    ],
    supportNotes: "Requested help with lease setup.",
  },
  {
    id: "3",
    firstName: "David",
    ...
    billingDate: "June 4, 2026",
    monthlyAmount: 0,
    activityLog: [
      { date: "May 28, 2026", action: "Started trial" },
    ],
    supportNotes: "",
  },
  {
    ...
    monthlyAmount: 0,
    activityLog: [
      { date: "April 27, 2026", action: "Trial expired" },
      { date: "April 20, 2026", action: "Started trial" },
    ],
