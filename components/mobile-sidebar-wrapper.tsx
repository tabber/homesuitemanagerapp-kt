...
export function MobileSidebarWrapper({ children }: MobileSidebarWrapperProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 overflow-y-auto transition-transform duration-200 md:static md:inset-auto md:z-auto md:w-auto md:[transform:none] ${
